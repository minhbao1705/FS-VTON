...
--lr 0.00003 --niter 100 --niter_decay 100 --resize_or_crop None --verbose --tf_log --batchSize 4 --num_gpus 2 --label_nc 14 --launcher pytorch --checkpoints_dir checkpoints_fs
